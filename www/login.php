...
<html>
<head>
	<title>Đăng nhập | NCT Judger</title>
	<meta charset="UTF-8">
		...
		<div class="container-login100" style="background-image: url('images/bg-01.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				<span class="login100-form-title p-b-41">
					Đăng nhập | NCT Judger
				</span>
				<form class="login100-form p-b-33 p-t-5" method="POST" action="<?php echo $_SERVER['PHP_SELF']?>">

					<div class="wrap-input100">
						<input class="input100" type="text" name="username" placeholder="Tên đăng nhập" <?php if (isset($_COOKIE['cooktname'])) echo "value='".$_COOKIE['cooktname']."'";?>>
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>

					<div class="wrap-input100">
						<input class="input100" type="password" name="password" placeholder="Mật khẩu" <?php if (isset($_COOKIE['cooktpass'])) echo "value='".$_COOKIE['cooktpass']."'";?>>
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
