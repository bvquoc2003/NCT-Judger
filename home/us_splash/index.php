...
<div id="wrap">
  ...
  <table>
   ...
   <td>
	...
	<ul>
	  <li> <b>MySQL 8.0.18-community</b></li>
	  <li> MySQL 5.7.28-community</li>	  
      <li> Mariadb 10.4.10</li>
	  <li> Mariadb 5.5.66</li>
	</ul>
	<br />
   ...
   <td>
	...
	<ul>
	  ...
	  <li> PHP v7.0.33</li>
	  <li> PHP v5.6.30</li>
	  <li> Pear - AutoInstaller</li>
    </ul>
	<br />
	
	<big><strong>PHP Accelerators</strong></big>
	<ul>
	  <li> Zend OpCache</li>
	</ul>
    <br /> 
	...
	<ul>
      <li> Strawberry Perl v5.30.0.1</li>
  ...
  <div id="content">
  <p>The Uniform Server is a WAMP package that allows you to run a server on any XP, Vista, W7, W8 or W10 Windows OS based computer 
  (UniServer ZeroXIV requires W8+). It is small and quick to download, and can be easily moved around. It also can be setup and 
  used as a production/live server.  Developers can use The Uniform Server to test their applications which require PHP, MySQL and 
  the Apache HTTPd Server.</p>
  </div>
